        ...
        <div class="col-12 col-md-12">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <a href="{{Route('barang-keluarAdd')}}" class="btn icon icon-left btn-success mb-3"><i data-feather="edit-2"></i> Tambah Data Barang Keluar</a>
                </div>
            </div>
            @endif
            @if (session('success'))
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-bold-500">
                                            @if(Auth::user()->role == 'User')
                                            <form action="{{Route('barang-keluarDelete', $data->id)}}" method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{Route('barang-keluarEdit', $data->id)}}" class="btn icon btn-primary"><i class="bi bi-pencil-square"></i></a>
